...
exports.default = _default;
        var $b5a4b7 = exports.default || module.exports;
      
      if (typeof $b5a4b7 === 'function') {
        $b5a4b7 = $b5a4b7.options;
      }
    
        /* template */
        Object.assign($b5a4b7, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b5a4b7', $b5a4b7);
          } else {
            api.reload('$b5a4b7', $b5a4b7);
          }
        }
